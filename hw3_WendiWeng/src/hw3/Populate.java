...
public class Populate {
    ...
    private static final String DB_USER = "Wendi";
    private static final String DB_PASS = "1188955";
    private static final String ORACLE_URL = "jdbc:oracle:thin:@localhost:1521:xe";
    private static final String JDBC_DRIVER = "oracle.jdbc.driver.OracleDriver";
    private static final String BUSINESS_JSON_FILE_PATH = "C:\\Users\\wendi\\Desktop\\hw3\\json_files\\yelp_business.json";
    private static final String USER_JSON_FILE_PATH = "C:\\Users\\wendi\\Desktop\\hw3\\json_files\\yelp_user.json";
    private static final String REVIEW_JSON_FILE_PATH = "C:\\Users\\wendi\\Desktop\\hw3\\json_files\\yelp_review.json";
    private static final String REVIEW_JSON_FILE_HALF_PATH = "C:\\Users\\wendi\\Desktop\\hw3\\json_files\\yelp_review_half.json";
        ...
        try (FileReader fileReader = new FileReader(file);
            ...
            while ((line = reader.readLine()) != null) {
                ...
                int votes = obj.getJSONObject("votes").getInt("useful")
                          ...
                          + obj.getJSONObject("votes").getInt("cool");
                // insert user data
                sql = "INSERT INTO YelpUser (user_id, name, yelping_since, review_count, average_stars, friend_count, votes) VALUES (?, ?, ?, ?, ?, ?, ?)";
                preparedStatement = connection.prepareStatement(sql);

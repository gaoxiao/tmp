...
//                        getAttributes();
    ...
    private void initComponents() {
        ...
        businessSearchForPanel.setBackground(new java.awt.Color(255, 204, 255));
        businessSearchForPanel.setForeground(new java.awt.Color(0, 102, 0));

        businessSearchForLabel.setBackground(new java.awt.Color(255, 204, 255));
        businessSearchForLabel.setForeground(new java.awt.Color(51, 51, 255));
        businessSearchForLabel.setText("Search for");

        businessSearchForComboBox.setBackground(new java.awt.Color(255, 255, 102));
        ...
        reviewResultPanel.setBackground(new java.awt.Color(255, 204, 255));
        ...
        userPanel.setBackground(new java.awt.Color(255, 153, 255));
        ...
        userSearchForPanel.setBackground(new java.awt.Color(255, 204, 255));

        userSearchForLabel.setBackground(new java.awt.Color(255, 204, 255));
        userSearchForLabel.setForeground(new java.awt.Color(51, 0, 255));
        userSearchForLabel.setText("Search for");

        userSearchForComboBox.setBackground(new java.awt.Color(255, 255, 102));
        ...
        queryPanel.setBackground(new java.awt.Color(255, 204, 255));
        ...
        businessRadioButton.setBackground(new java.awt.Color(255, 204, 255));
        businessRadioButton.setForeground(new java.awt.Color(51, 51, 255));
        businessRadioButton.setText("search for business");
        businessRadioButton.setToolTipText("");

        userRadioButton.setBackground(new java.awt.Color(255, 204, 255));
        userRadioButton.setForeground(new java.awt.Color(51, 51, 255));
